...
ASFLAGS = $(CFLAGS) 
LFLAGS =  -LD:\PROGRA~1\icc\lib\ -g -e:0x20000 -ucrtboot128.o -bvector:0x1e000.0x20000 -bfunc_lit:0x1e08c.0x20000 -dram_end:0x10ff -bdata:0x100.0x10ff -dhwstk_size:256 -beeprom:0.4096 -fihx_coff -S2
FILES = SBL.o 
