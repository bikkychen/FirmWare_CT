...
#define SCLK_TRIS TRISDbits.TRISD1
#define CS PORTDbits.RD0
...
//******FLASH端口
#define SCK PORTBbits.RB3
#define SCK_TRIS TRISBbits.TRISB3
#define SI PORTBbits.RB2
#define SI_TRIS TRISBbits.TRISB2
#define SO PORTBbits.RB0
#define SO_TRIS TRISBbits.TRISB0
#define F1CS PORTBbits.RB1
#define F1CS_TRIS TRISBbits.TRISB1
