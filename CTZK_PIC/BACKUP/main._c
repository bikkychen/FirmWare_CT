...
void Start(void)
{
 ...
 ACSR&=0xf7;//关模拟比较器中断，
 ACSR|=0x02;//开模拟比较器,AIN1连到比较器负极，0:比较器输出变化即中断，1：保留，2：下降沿中断，3:上升沿中断       
...
//将电机过流档位换算为数字量，方便中断函数中进行比较运算
  ...
  //第1档从100mA起步，每档差值30mA,7.721/10mA，第6档约250mA
  Motor1Thr= 78+ (Motor1Gear-1)*23;
  Motor2Thr= 78+ (Motor2Gear-1)*23;
