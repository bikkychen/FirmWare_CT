...
/**************************
    单片机端口宏定义
***************************/
#define TEST PORTAbits.RA3		//AVDD控制端口
#define TEST_TRIS TRISAbits.TRISA3
...
#define EXC PORTDbits.RD0
#define EXC_TRIS TRISDbits.TRISD0
...
#define CS PORTDbits.RD5
#define CS_TRIS TRISDbits.TRISD5
#define CS0 {CS=0;Nop();Nop();Nop();Nop();Nop();Nop();Nop();Nop();Nop();Nop();}
#define CS1 {Nop();Nop();Nop();Nop();Nop();CS=1;}
*/
...
#define F1CS0 {F1CS=0;Nop();Nop();Nop();Nop();Nop();Nop();Nop();Nop();}
...
/*****************************
       模拟SPI操作AD7799
******************************/
extern uchar RecAD7799(void);	//读AD7799两个字节
...
extern void ReadAD7799_16F1(void);   //16位转换读流量F1,正
//extern void Meas_Time(void);        //测一次传播时间
extern void ReadAD7799_16F2(void);   //16位转换读流量F2,负
//extern void ReadAD7799_VBat(void); //16位转换读电池电压
extern void AD_10BIT(void);

extern void ReadAD_MODE0(void);	    //采样读压力温度
extern void ReadAD_MODE1(void);	    //采样读压力温度
extern void ReadAD_MODE8(void);	    //采样读压力温度
extern void ReadAD_MODE9(void);	    //采样读流量压力温度
